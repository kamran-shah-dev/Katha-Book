...
export default function CashbookReport() {
  ...
  const handleExportExcel = () => {
    ...
    const excelData: ExcelRow[] = rows.map((r, i) => {
      ...
      <body>
        ...
        <div class="summary-box">
          ...
          <div style="border-top: 2px solid #000; padding-top: 8px; margin-top: 8px;">
            <strong>Cash In Hand:</strong> Rs. ${balance.toLocaleString()}
          </div>
        </div>
      </body>
      </html>
      ...
      {rows.length > 0 && (
        <div ref={printRef} className="bg-white p-8 rounded shadow-lg">
          ...
          <div className="mt-6 ml-auto p-4 border-2 border-black bg-gray-50 w-80">
            ...
            <div className="flex justify-between pt-2 mt-2 border-t-2 border-black font-bold">
